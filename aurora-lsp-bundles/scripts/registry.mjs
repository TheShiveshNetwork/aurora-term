...
export const REGISTRY = [
  ...
  { id: "terraform", eco: "github", repo: "hashicorp/terraform-ls",
    assets: { "win-x64": "terraform-ls_{version}_windows_amd64.zip", "linux-x64": "terraform-ls_{version}_linux_amd64.zip", "darwin-x64": "terraform-ls_{version}_darwin_amd64.zip", "darwin-arm64": "terraform-ls_{version}_darwin_arm64.zip" },
    entry_relative: "terraform-ls", args: ["serve"] },
